"use strict";var influxdb=(()=>{var Wo=Object.defineProperty;var Sf=Object.getOwnPropertyDescriptor;var xf=Object.getOwnPropertyNames;var Tf=Object.prototype.hasOwnProperty;var or=(r,t)=>{for(var e in t)Wo(r,e,{get:t[e],enumerable:!0})},Bf=(r,t,e,i)=>{if(t&&typeof t=="object"||typeof t=="function")for(let n of xf(t))!Tf.call(r,n)&&n!==e&&Wo(r,n,{get:()=>t[n],enumerable:!(i=Sf(t,n))||i.enumerable});return r};var Of=r=>Bf(Wo({},"__esModule",{value:!0}),r);var Ip={};or(Ip,{AbortError:()=>Ii,DEFAULT_ConnectionOptions:()=>Jo,DEFAULT_QueryOptions:()=>Pn,DEFAULT_WriteOptions:()=>qo,GetFieldTypeMissmatchError:()=>zn,HttpError:()=>Ae,IllegalArgumentError:()=>ar,InfluxDBClient:()=>Vn,Log:()=>Br,Point:()=>Si,PointValues:()=>cr,RequestTimedOutError:()=>$o,collectAll:()=>tl,consoleLogger:()=>zc,convertTime:()=>ta,convertTimeToNanos:()=>Qo,createTextDecoderCombiner:()=>Ho,currentTime:()=>Gc,dateToProtocolTimestamp:()=>Xc,escape:()=>Ne,fromConnectionString:()=>Ko,fromEnv:()=>Go,setLogger:()=>Df,useProcessHrtime:()=>Kc,writableDataToLineProtocol:()=>ea});var ar=class r extends Error{constructor(t){super(t),this.name="IllegalArgumentError",Object.setPrototypeOf(this,r.prototype)}},Ae=class r extends Error{constructor(e,i,n,s,o,a){var c;super();this.statusCode=e;this.statusMessage=i;this.body=n;this.contentType=s;this.headers=o;if(Object.setPrototypeOf(this,r.prototype),a)this.message=a;else if(n&&(s!=null&&s.startsWith("application/json")||!s))try{if(this.json=JSON.parse(n),this.message=this.json.message,this.code=this.json.code,!this.message){let l=this.json;(c=l.data)!=null&&c.error_message?this.message=l.data.error_message:l.error&&(this.message=l.error)}}catch(l){}this.message||(this.message=`${e} ${i} : ${n}`),this.name="HttpError"}},$o=class r extends Error{constructor(){super(),Object.setPrototypeOf(this,r.prototype),this.name="RequestTimedOutError",this.message="Request timed out"}},Ii=class r extends Error{constructor(){super(),this.name="AbortError",Object.setPrototypeOf(this,r.prototype),this.message="Response aborted"}};function Ho(){let r=new TextDecoder("utf-8");return{concat(t,e){let i=new Uint8Array(t.length+e.length);return i.set(t),i.set(e,t.length),i},copy(t,e,i){let n=new Uint8Array(i-e);return n.set(t.subarray(e,i)),n},toUtf8String(t,e,i){return r.decode(t.subarray(e,i))}}}var Jo={timeout:1e4,queryTimeout:6e4},qo={precision:"ns",gzipThreshold:1e3},Pn={type:"sql"};function Ko(r){if(!r)throw Error("Connection string not set!");let t=new URL(r.trim(),"http://localhost"),e={host:r.indexOf("://")>0?t.origin+t.pathname:t.pathname};return t.searchParams.has("token")&&(e.token=t.searchParams.get("token")),t.searchParams.has("authScheme")&&(e.authScheme=t.searchParams.get("authScheme")),t.searchParams.has("database")&&(e.database=t.searchParams.get("database")),t.searchParams.has("timeout")&&(e.timeout=parseInt(t.searchParams.get("timeout"))),t.searchParams.has("precision")&&(e.writeOptions||(e.writeOptions={}),e.writeOptions.precision=t.searchParams.get("precision")),t.searchParams.has("gzipThreshold")&&(e.writeOptions||(e.writeOptions={}),e.writeOptions.gzipThreshold=parseInt(t.searchParams.get("gzipThreshold"))),e}function Go(){if(!process.env.INFLUX_HOST)throw Error("INFLUX_HOST variable not set!");if(!process.env.INFLUX_TOKEN)throw Error("INFLUX_TOKEN variable not set!");let r={host:process.env.INFLUX_HOST.trim()};return process.env.INFLUX_TOKEN&&(r.token=process.env.INFLUX_TOKEN.trim()),process.env.INFLUX_AUTH_SCHEME&&(r.authScheme=process.env.INFLUX_AUTH_SCHEME.trim()),process.env.INFLUX_DATABASE&&(r.database=process.env.INFLUX_DATABASE.trim()),process.env.INFLUX_TIMEOUT&&(r.timeout=parseInt(process.env.INFLUX_TIMEOUT.trim())),process.env.INFLUX_PRECISION&&(r.writeOptions||(r.writeOptions={}),r.writeOptions.precision=process.env.INFLUX_PRECISION),process.env.INFLUX_GZIP_THRESHOLD&&(r.writeOptions||(r.writeOptions={}),r.writeOptions.gzipThreshold=parseInt(process.env.INFLUX_GZIP_THRESHOLD)),r}var zc={error(r,t){console.error(`ERROR: ${r}`,t||"")},warn(r,t){console.warn(`WARN: ${r}`,t||"")}},jn=zc,Br={error(r,t){jn.error(r,t)},warn(r,t){jn.warn(r,t)}};function Df(r){let t=jn;return jn=r,t}function Xo(r,t){return function(e){let i="",n=0,s=0;for(;s<e.length;){let o=r.indexOf(e[s]);o>=0&&(i+=e.substring(n,s),i+=t[o],n=s+1),s++}return n==0?e:(n<e.length&&(i+=e.substring(n,e.length)),i)}}function Ff(r,t){let e=Xo(r,t);return i=>`"${e(i)}"`}var Ne={measurement:Xo(`, 
\r	`,["\\,","\\ ","\\n","\\r","\\t"]),quoted:Ff('"\\',['\\"',"\\\\"]),tag:Xo(`, =
